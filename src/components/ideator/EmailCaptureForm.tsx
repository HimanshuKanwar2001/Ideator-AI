...
export function EmailCaptureForm({ onSubmit, isSubmitting }: EmailCaptureFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 p-6 border rounded-lg shadow-lg bg-card">
        <h3 className="text-lg font-semibold font-headline text-center">Unlock Your AI-Generated Ideas!</h3>
